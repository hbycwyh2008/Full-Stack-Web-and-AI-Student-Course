...
6. **Independent rebuild:** hand-type mini full-stack in `full-stack-practice/independent-rebuild/lesson-05/` — [independent-rebuild.md](../shared/independent-rebuild.md).
