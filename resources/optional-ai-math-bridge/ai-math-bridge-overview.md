...
Create in your **personal** GitHub repo (`student-portfolio`). See `templates/student-git-hub-repository-guide.md`.
...
Use `templates/ai-math-bridge-readme-template.md` for the README. Lesson guides: [README.md](README.md).
