...
Full system: [Evidence System](../assessment/evidence-system.md)
...
| Evidence | What it is |
|---|---|
| **Program code** | Your code in your GitHub repo |
| **Program report** | README explaining what, how, and why |
| **Reflection** | What you learned, what was hard, what you fixed |
| **Revision record** | Commits showing you improved after testing or feedback |
| **GitHub commit history** | Multiple meaningful commits over time |
| **AI usage note** | Required when AI helped; state “No AI used” if not |
...
Checklist: [exit-evidence-checklist](../class-missions/shared/exit-evidence-checklist.md)
...
- “I watched the video”
- Code that runs once with no commits
- One commit named `update` or `final`
- Copied work you cannot explain
- AI output with no revision or disclosure
- Screenshot with no matching change in your repo
...
Back to [student-start-here.md](../student-start-here.md)
