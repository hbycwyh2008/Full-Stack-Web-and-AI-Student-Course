...
## Regular Class Track — 6 Missions

| Class | Open this file | Coursera module |
|---|---|---|
| 1 | [lesson-01-introduction-and-rest-apis.md](lesson-01-introduction-and-rest-apis.md) | Module 1 — Introduction |
| 2 | [lesson-02-getting-started-first-api.md](lesson-02-getting-started-first-api.md) | Module 2 — Getting Started |
| 3 | [lesson-03-path-parameters.md](lesson-03-path-parameters.md) | Module 3 — Path Parameter |
| 4 | [lesson-04-query-parameters-and-post.md](lesson-04-query-parameters-and-post.md) | Module 4 — Query Parameter |
...
[Phase 02: Database](../Phase_02_Database/)
