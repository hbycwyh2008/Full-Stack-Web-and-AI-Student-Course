...
## Regular Class Track — 4 Missions

| Class | Open this file | Coursera module |
|---|---|---|
| 7 | [lesson-07-sql-database-sqlite.md](lesson-07-sql-database-sqlite.md) | Module 7 — SQL Database |
| 8 | [lesson-08-sqlmodel-and-dependency-injection.md](lesson-08-sqlmodel-and-dependency-injection.md) | Module 8 — SQLModel |
| 9 | [lesson-09-asyncio-in-fastapi.md](lesson-09-asyncio-in-fastapi.md) | Module 9 — AsyncIO |
| 10 | [lesson-10-postgresql-and-submission.md](lesson-10-postgresql-and-submission.md) | Module 10 — PostgreSQL |

---

## Previous Block

[Phase 01: FastAPI](../Phase_01_FastAPI/)
