...
**Student folder:** `full-stack-practice/` · memory-only: `full-stack-practice/independent-rebuild/lesson-0X/`
...
| Class | File | Udemy focus (typical) |
|---|---|---|
| 1 | [lesson-01-setup-and-course-map.md](lesson-01-setup-and-course-map.md) | Intro, stack overview, environment |
| 2 | [lesson-02-fastapi-backend-first-api.md](lesson-02-fastapi-backend-first-api.md) | Project 1 — FastAPI setup & routes |
| 3 | [lesson-03-nextjs-frontend-and-fetch.md](lesson-03-nextjs-frontend-and-fetch.md) | Project 1 — Next.js setup & fetch |
