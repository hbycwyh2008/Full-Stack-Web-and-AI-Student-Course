...
| Class | Open this file | Main resource |
|---|---|---|
| 1 | [lesson-01-figma-basics-and-user-flow.md](lesson-01-figma-basics-and-user-flow.md) | [Figma Design for beginners (2025)](https://help.figma.com/hc/en-us/articles/30848209492887-Course-overview-Figma-Design-for-beginners-2025) — start |
...
```text
figma-design/
├── README.md              ← user flow, design decisions
├── figma-link.md          ← share link + view access note
├── user-flow.md           ← or photo of paper sketch
└── screenshots/           ← PNG exports of key frames
```

**Figma file:** name it `AI-School-Assistant` (or teacher-assigned name).
...
```text
0–15   Individual Learning (one resource / module)
15–27  Talk Robin / Group Discussion
27–37  Group Answer
37–45  Entry Points Check
45–70  Mission Task (Figma + GitHub evidence)
...
## Capstone Screens (All Lessons Build Toward These)

| # | Screen | Must show |
|---|---|---|
| 1 | Home / welcome | App name, what it does |
| 2 | Ask question | Text input, submit |
| 3 | Loading | User waits for backend |
| 4 | Result | **Answer + source** (handbook section) |
...
Formal overview: your teacher will share the Phase 4 Figma evidence table.
