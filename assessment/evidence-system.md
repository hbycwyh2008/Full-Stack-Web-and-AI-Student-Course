...
Student guide: [how-to-submit-evidence.md](../student-start/03-how-to-submit-evidence.md)
...
| **AI usage note** | Honest disclosure when AI helped | Per [AI Usage Policy](ai-usage-policy.md) |
...
Levels: [mastery-levels](../class-missions/shared/mastery-levels.md)
...
Phase requirements: your teacher will assign the checklist for each phase.

Class missions: [class-missions/](../class-missions/) — **Exit Evidence** per session.

Summative rubrics: [assessment-rubric.md](assessment-rubric.md), [presentation-rubric.md](presentation-rubric.md)
